...
# this classa creates API clien that will be used in tests
class Github:
    def get_user(self, username):
        r = requests.get(f"https://api.github.com/users/{username}") # returns an HTTP response object
        body = r.json() # convers the JSON response (body) into a Python list
    ...
    def get_commits_list(self, name, repo):
